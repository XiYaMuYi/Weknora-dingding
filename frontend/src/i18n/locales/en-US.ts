export default {
  ...
  knowledgeEditor: {
    ...
    sidebar: {
      ...
      imageCompression: 'Image Storage Optimization',
      share: 'Sharing',
      indexing: 'Indexing Strategy',
    },
    imageCompression: {
      title: 'Existing Image Storage Optimization',
      description: 'Compress and replace large, fully processed images in this knowledge base to reduce long-term storage and retrieval traffic.',
      scopeNote: 'Only existing images in this knowledge base are processed. OCR, multimodal analysis, and RAG indexes are not rerun. The compressed object is stored and selected before the original is deleted.',
      eligible: 'Eligible images',
      sourceSize: 'Current size',
      target: 'Per-image target',
      progress: 'Progress',
      succeeded: '{count} succeeded',
      retrying: '{count} awaiting retry',
      failed: '{count} failed',
      saved: '{size} saved',
      refresh: 'Refresh estimate',
      start: 'Start optimization',
      running: 'Optimizing',
      started: 'Image optimization task started',
      previewFailed: 'Could not load the image optimization estimate',
      startFailed: 'Could not start image optimization',
      confirmTitle: 'Compress existing images?',
      confirmBody: 'This will process {count} images totaling about {size}. It runs in the background at low priority, retries failures in rounds, and does not rebuild RAG indexes.',
    },
    errors: {
...
\
  ...
  datasource: {
    ...
    resourceRequired: 'Select a space, wiki, or folder to sync. If listing permissions are not available yet, go back and enter the ID manually.',
    untitled: 'Untitled',
    ...
    dingtalk: {
      section: 'DingTalk document settings',
      typeLabel: 'DingTalk document type',
      drive: 'Drive',
      wiki: 'Wiki',
      unionIdHint: 'Enter the DingTalk member UnionID that can access the selected drive or wiki. This is not the enterprise CorpId.',
      manualResourceIds: 'Enter IDs manually when list selection is unavailable (optional)',
      manualResourceIdsHint: 'Prefer selecting from the next-step list. Use manual IDs only when listing permissions are not ready; one per line. For wiki, enter workspaceId; for drive, enter spaceId.',
      manualModeHint: 'Manual ID mode is active. The next step will skip list selection and only save the IDs entered here.',
      manualIdUrlWarning: 'Enter the ID, not a browser URL. For wiki use workspaceId; for drive use spaceId.',
      manualIdTypeMismatchWiki: 'Wiki is selected. Enter a wiki ID (wiki:<ID> or workspaceId), not space:<ID>.',
      manualIdTypeMismatchDrive: 'Drive is selected. Enter a drive ID (space:<ID> or spaceId), not wiki:<ID>.',
    },
