...
import (
	...
	dingtalkDSConnector "github.com/Tencent/WeKnora/internal/datasource/connector/dingtalk"
...
func BuildContainer(container *dig.Container) *dig.Container {
	...
	must(container.Provide(service.NewKnowledgeMediaService))
	...
	must(container.Provide(handler.NewKnowledgeMediaHandler))
	// IM integration
...
func initConnectorRegistry() (*datasource.ConnectorRegistry, error) {
	...
	if err := registry.Register(dingtalkDSConnector.NewConnector()); err != nil {
